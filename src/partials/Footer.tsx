...
export const Footer = (props: {}) => {
  return (
    <footer className="w-full bg-base-300 shadow-xl p-5 flex flex-col items-center space-y-5">
      ...
      <a href="https://github.com/hyuse202/KUKU"target="_blank" className="text-gray-300">Special thanks to Kitsune for amazaing anime website</a>
      ...
      <p className="text-sm text-gray-300">
        KUKU does not store any files on our server, we only linked to the
